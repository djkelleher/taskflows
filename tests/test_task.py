...
from taskflows.tasks import _RuntimeManager, build_loki_query_url, run_task
...
def test_loki_query_url_with_explicit_times():
    ...
    end_time = datetime(2024, 1, 1, 11, 0, 0, tzinfo=UTC)
...
def test_runtime_manager_fast_path_rechecks_portal_health():
    ...
    manager._last_health_check = datetime.now(UTC).timestamp()

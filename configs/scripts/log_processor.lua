-- Simplified log processor for both user services and Docker containers
-- Focuses on service name extraction and timestamp normalization
...
function process_log(tag, timestamp, record)
    ...
    -- Clean up - only keep essential fields
    local clean_record = {
        MESSAGE = message,
